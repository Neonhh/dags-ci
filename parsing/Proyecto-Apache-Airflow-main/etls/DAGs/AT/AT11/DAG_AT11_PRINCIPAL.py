...
holiday_sensor = AT44_PRIMER_DIA_HABIL(     # En la secuencia de ejecucion, colocar este operador en el orden que convenga
    ...
    postgres_conn_id='at11', 
    poke_interval=10,                    # Se verifica cada 10 segundos para la prueba (para produccion seria 86400seg para una verificacion diaria)
    dag=dag
)

Execution_of_the_Scenario_AT11_version_001_task = TriggerDagRunOperator(
    task_id='Execution_of_the_Scenario_AT11_version_001_task',
    trigger_dag_id='AT11', 
...
holiday_sensor >> Execution_of_the_Scenario_AT11_version_001_task
