...
def transform(**kwargs):
    ...
    df_joined['fecha'] = df_joined['fecha'].astype(str)
...
def load(**kwargs):
    ...
    # Tabla destino
    create_table_sql = """
    CREATE TABLE IF NOT EXISTS destino1 (
        id INT,
        name VARCHAR(100),
        catastro VARCHAR(50),
        fecha DATE
    ...
    # INSERT
    insert_sql = """
    INSERT INTO destino1 (id, name, catastro, fecha)
    VALUES (%s, %s, %s, %s);
    """
    ...
    print(f"Load: registros cargados en destino1.", joined_records)
