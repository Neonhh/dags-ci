...
def IT_CL_DIAS_FERIADOS_COBIS_INICIAL(**kwargs):
...
dag = DAG(dag_id='PKG_COB_LOAD_CL_DIAS_FERIADOS_COBIS_ODS_INICIAL',
...
IT_CL_DIAS_FERIADOS_COBIS_INICIAL_task = PythonOperator(
    task_id='IT_CL_DIAS_FERIADOS_COBIS_INICIAL_task',
    python_callable=IT_CL_DIAS_FERIADOS_COBIS_INICIAL,
    dag=dag
)

###### SECUENCIA DE EJECUCION ######
vSrcNombreTablaOds_task >> vSrcFechaCarga_task >> vSrcFormatoFecha_task >> vSrcPeriodoFechaCarga_task >> vSrcCorteFechaCarga_task >> vSrcTipoCarga_task >> vSrcFirstDayMonth_task >> vSrcLastDayMonth_task >> IT_CL_DIAS_FERIADOS_COBIS_INICIAL_task
