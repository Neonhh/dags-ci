...
def IT_IF_CATEGORIA_RECL_GIR5_ODS(**kwargs):
    ...
    # Create work table
    sql_query_deftxt = f'''CREATE TABLE IF NOT EXISTS ods.COL_PRF0IF_CATEGORIA_RECL_GIR5 (
    ...
    # create target table
    sql_query_deftxt = f'''CREATE TABLE IF NOT EXISTS ods.if_categoria_recl_gir5 (
    ...
    sql_query_deftxt = f'''TRUNCATE TABLE ods.if_categoria_recl_gir5;'''
    logger.info("Accion a ejecutarse: Truncate target table") 
    hook.run(sql_query_deftxt)
    logger.info("Accion: Truncate target table, ejecutada exitosamente") 

    # Insert new rows
    sql_query_deftxt = f'''INSERT INTO ods.if_categoria_recl_gir5 (
	tc_secuencial,
	tc_cod_categ,
	tc_cod_recl,
	tc_tipo_recl,
    ...
    # Drop work table
    sql_query_deftxt = f'''DROP TABLE ods.COL_PRF0IF_CATEGORIA_RECL_GIR5;'''
