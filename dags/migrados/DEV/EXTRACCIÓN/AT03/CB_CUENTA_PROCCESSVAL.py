...
dag = DAG(dag_id='PKG_CON_PROCCESSVAL_CB_CUENTA_COB_CONTA_ODS',
...
vSrcNombreTablaOds_task >> vOdsFechaInicio_task >> vOdsFechaFin_task >> vSrcFormatoFecha_task >> PROC_UPD_CONFIG_ODS_task >> vSrcFechaCarga_task >> PKG_CON_LOAD_CB_CUENTA_COB_CONTA_ODS_task >> PROC_UPD_STATUS_BAN_CONFIG_ODS_task
