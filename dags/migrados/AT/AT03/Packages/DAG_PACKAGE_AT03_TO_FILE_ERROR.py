...
def AT03_ATSUDEBAN_ERROR(**kwargs):
    ...
    # Generate header
    sql_query_deftxt = '''CREATE TABLE IF NOT EXISTS <?=snpRef.getObjectName('L', 'header', '', 'D')?> (
